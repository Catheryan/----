...
package com.yzh.android.db.table;

import android.text.TextUtils;

import com.lidroid.xutils.db.annotation.Id;
import com.lidroid.xutils.db.annotation.Table;
import com.yzh.android.db.converter.ColumnConverterFactory;
import com.yzh.android.util.LogUtils;
...
public class TableUtils {
	 ...
	 * key: entityType.name
	 */
	private static ConcurrentHashMap<String, com.yzh.android.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.yzh.android.db.table.Id>();

	/* package */
	static synchronized com.yzh.android.db.table.Id getId(Class<?> entityType) {
		if (Object.class.equals(entityType)) {
		...
		com.yzh.android.db.table.Id id = new com.yzh.android.db.table.Id(entityType, primaryKeyField);
		entityIdMap.put(entityType.getName(), id);
		return id;
	}

	private static String getPrimaryKeyFieldName(Class<?> entityType) {
		com.yzh.android.db.table.Id id = getId(entityType);
