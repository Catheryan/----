	...
	public static DTO<String,Object> gainForm(ViewGroup root,DTO<String,Object> data) {
		if (root.getChildCount() > 0) {
			for (int i = 0; i < root.getChildCount(); i++) {
				...
				} else if (view instanceof com.yzh.android.view.RadioGroup) {
					gainForm((com.yzh.android.view.RadioGroup) view,data);
				...
				}else if (view.getClass().getName().equals(com.yzh.android.view.RadioButton.class.getName())) {
					com.yzh.android.view.RadioButton mView = (com.yzh.android.view.RadioButton)view;
					if (mView.isChecked()) {
				...
				}else if (view.getClass().getName().equals(com.yzh.android.view.CheckBox.class.getName())) {
					
					com.yzh.android.view.CheckBox mView = (com.yzh.android.view.CheckBox)view;
					if (mView.isChecked()) {
				...
				}else if (view.getClass().getName().equals(com.yzh.android.view.SingleSpinner.class.getName())) {
					com.yzh.android.view.SingleSpinner mView = (com.yzh.android.view.SingleSpinner)view;
